  ...
  <div class="card border scroll-500">
    <div class="card-body">
      ...
      <p class="text-break mt-3">
        BlastChat is the first decentralized social network on the Blast L2 chain.
      </p>
      ...
      <ul>
        <li><a href="https://id.blastchat.xyz" target="_blank">BlastChat ID</a></li>
        <li><a href="https://github.com/blastchatxyz" target="_blank">GitHub</a></li>
